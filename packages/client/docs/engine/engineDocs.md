...
- **gravity**: Вертикальное ускорение
- **jumpPower**: Скорость подъёма при прыжке
- **pipeSpeed**: Скорость горизонтального движения труб
- **pipeGap**: Вертикальное расстояние между трубами
- **pipeWidth**: Ширина труб
- **pipeFrequency**: Количество кадров между созданием труб
